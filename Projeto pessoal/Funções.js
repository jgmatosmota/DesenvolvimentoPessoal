...
function mostrarHistoria(){
    ...
    img_esquerda.src=`images/imgbin_human-behavior-thought-art-gandalf-png.png`
    img_esquerda.style = "width:"
   if(contador==0) {contador++}
    
}
function mostrarHistoria1(){
    img_esquerda.src= `images/imgbin_sauron-samwise-gamgee-gandalf-frodo-baggins-drawing-png.png`
    papiroH.style.display="block"
...
function mostrarHistoria2(){
    img_esquerda.src = `images/pngkey.com-frodo-baggins-png-5898534.png`
